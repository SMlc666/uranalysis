...
| Compare and test | `cmp`, `cmpxchg`, `test`, `bt`, `bsf`, `setcc` | Partial | Implemented | Implemented | Yes | Not measured | Common 64-bit and byte GPR forms, `cmp al, imm8`, `test al, imm8`, byte `test`, byte/imm8/imm32 group, `f6`/`f7 /0`, selected lock-prefixed atomics, `cmpxchg r/m16/32/64, r16/32/64`, `bt r/m, r`, `bt r/m, imm8`, `bsf r, r/m`, and `setcc r/m8` forms only. |
| Logical | `and`, `or`, `xor`, `not`, `rol`, `ror`, `rcl`, `rcr`, `shl`, `shr`, `sar`, `bts`, `btr`, `btc` | Partial | Implemented | Implemented | Yes | Not measured | Common 64-bit and byte GPR forms, AL imm8 forms, byte/imm8/imm32 group, shift imm8 groups, implicit-count-one shift groups, bit-test immediate mutation forms, and `f6`/`f7 /2` forms only. |
