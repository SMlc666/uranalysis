...
| Compare and test | `cmp`, `test`, `setcc` | Partial | Implemented | Implemented | Yes | Not measured | Common 64-bit GPR, byte `test`, byte/imm8/imm32 group, `f6`/`f7 /0`, and `setcc r/m8` forms only. |
| Logical | `and`, `or`, `xor`, `not`, `rol`, `ror`, `rcl`, `rcr`, `shl`, `shr`, `sar` | Partial | Implemented | Implemented | Yes | Not measured | Common 64-bit GPR, byte/imm8/imm32 group, shift imm8 groups, and `f6`/`f7 /2` forms only. |
