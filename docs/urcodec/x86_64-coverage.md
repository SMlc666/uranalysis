...
| Compare and test | `cmp`, `cmpxchg`, `test`, `bt`, `bsf`, `setcc` | Partial | Implemented | Implemented | Yes | Not measured | Common 64-bit and byte GPR forms, `cmp al, imm8`, `test al, imm8`, byte `test`, byte/imm8/imm32 group, `f6`/`f7 /0`, selected lock-prefixed atomics, `cmpxchg r/m16/32/64, r16/32/64`, `bt r/m, r`, `bsf r, r/m`, and `setcc r/m8` forms only. |
...
| SSE/AVX | `movups`, `movaps`, `xorps`, `mulps`, `mulsd`, `cmpps`, `movd`, `movq`, `pcmpeqb`, `psrlq`, `psrldq`, `psllq`, `pslldq`, `vmovdqa`, `vmovdqu`, `vmovntdq`, `vpmovmskb`, `vmulps`, `vmulsd`, `vzeroupper` | Partial | Implemented | Implemented | Yes | Not measured | Basic legacy XMM forms plus corpus-driven 2-byte and 3-byte VEX.128/VEX.256 decode for selected AVX move, multiply, mask, packed-shift immediate, and cleanup forms only. |
| MMX | `movd`, `movq`, `pcmpeqb`, `pavgb`, `pmaddwd`, `psllw`, `psrlq`, `psllq`, `paddw`, `pmovmskb` | Partial | Implemented | Implemented | Yes | Not measured | Corpus-driven legacy MMX register/memory forms plus selected packed-shift immediate forms only; 3DNow remains out of scope. |
