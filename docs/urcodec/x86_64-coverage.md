...
| SSE/AVX | `movups`, `movaps`, `xorps`, `cmpps`, `vaddps` | Partial | Implemented | Implemented | Yes | Not measured | Basic legacy XMM `movups`, `movaps`, `xorps`, and generic `cmpps imm8` forms only; AVX remains out of scope. |
