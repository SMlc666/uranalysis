...
| Compare and test | `cmp`, `test`, `setcc` | Partial | Implemented | Implemented | Yes | Not measured | Common 64-bit and byte GPR forms, `cmp al, imm8`, `test al, imm8`, byte `test`, byte/imm8/imm32 group, `f6`/`f7 /0`, and `setcc r/m8` forms only. |
